...
Its just a protected version of (Simple/Demo3) your events with ability to add users and filter category and search events. You are able to add and remove categories manualy, see documentation.
